...
import bots.mctsbot.ai.bots.bot.gametree.mcts.strategies.selection.myUCTSelector;
...
public class MCTSMeerkatBot implements Player {
	...
	public void holeCards(Card c1, Card c2, int seat) {
		...
		myHand.addCard(c1);
		myHand.addCard(c2);
		gameStateContainer.setGameState(
				new NewPocketCardsState(gameStateContainer.getGameState(), playerIdCache.get(Integer.valueOf(seat)), new NewPocketCardsEvent(myHand)));
	...
	private void seatUpBot(int seat) {
		...
		try {
			...
			botFactory = new MCTSBotFactory("MCTSBot", // 
					WekaRegressionModelFactory.createForZip("bots/mctsbot/ai/opponentmodels/weka/models/model1.zip", config), //
					//new SamplingToFunctionSelector(20, new WeightedUCTSelector(108.6957)), // decisionSelection
					//new SamplingToFunctionSelector(20, new myUCTSelector(10)),
					new SamplingToFunctionSelector(20, new myUCTSelector(10)), new SamplingSelector(), // opponentSelection
